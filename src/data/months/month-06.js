export default {
  ...
  name: "Місяць 6",
  phase: 2,
  phaseName: "DUP — Undulating Periodization",
  phaseColor: "#f5a623",
  description: "DUP: Пн — сила (4x4-6), Ср — гіпертрофія (3x8-12), Пт — витривалість (3x12-15). W3 — тест 3RM.",
  weeks: [
    {
      id: 1,
      name: "Легкий",
    ...
    },
    {
      ...
      name: "Тест 3RM",
      rpeTarget: "max",
      note: "Тестовий тиждень — визнач свій 3RM. Порівняй з результатами M3. Estimated 1RM = вага × 1.08.",
      workouts: [
        {
          id: 1,
          day: "Понеділок",
    ...
    },
    {
      ...
      workouts: [
        ...
        },
        {
          id: 2,
          day: "Середа",
          name: "Full Body B — Гіпертрофія (Deload)",
          duration: "30-40 хв",
          warmup: "5-10 хв легке кардіо + динамічна розтяжка",
          exercises: [
            {
        ...
        },
        {
          id: 3,
          day: "П'ятниця",
          name: "Full Body C — Витривалість (Deload)",
          duration: "30-40 хв",
          warmup: "5-10 хв легке кардіо + динамічна розтяжка",
          exercises: [
            {
